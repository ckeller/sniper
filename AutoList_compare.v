...
Section Lists.
 ...
 (* Theorem length_zero_iff_nil : forall (l : list A),
  ...
  Proof.
    Time induction l ; snipe. Undo. Time induction l ; snipe2.
  Qed. *)
  ...
  Proof.
    Time intros l ; induction l ; snipe. Undo.
    Time intros l ; induction l ; snipe2.
  Qed. 

  Theorem app_assoc_reverse : forall l m n:list A, ((l ++ m) ++ n) = (l ++ m ++ n).
  Proof.
     Time snipe app_assoc. Undo.
...
(l ++ l') = nil -> l = nil /\ l' = nil.
  Proof.
  Time snipe. Undo. Time snipe2. Qed. *)
  ...
  Proof.
    Time induction l; snipe app_comm_cons. Undo. 
...
Admitted.
  ...
  Proof.
   Time snipe (in_app_or, in_or_app). Undo. Time snipe2 (in_app_or, in_or_app). Qed.
